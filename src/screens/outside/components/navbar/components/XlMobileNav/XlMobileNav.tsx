...
export default function XlMobileNav() {
  return (
          <nav className="hidden md:flex flex-col h-32 w-full top-8 overflow-hidden">
            <div className="flex flex-row h-20 justify-between items-center px-16">
              <NavLink to={'..'}>
            ...
            <div className="flex flex-row h-12 w-full justify-between items-center bg-redColor px-16">

          ...
          <div>
            <div className={`fixed h-full z-30 top-0 w-[80%] bg-easyGrayColor animate__animated animate__slideInLeft duration-300 p-6 ${mobileNav ? 'left-0 opacity-100' : 'left-[100%] opacity-0 '}`}>
              ...
              <div className="flex flex-row items-center my-6 gap-x-4">
                ...
                <Link to={'/user/login'} className="text-sm hover:text-redColor transition" onClick={()=>setMobileNav(!mobileNav)}>
                  Login
                </Link>

                <div className="border-[1px] h-[20px] border-grayColor " />

                <Link to={'/user/registration'} className="text-sm hover:text-redColor transition" onClick={()=>setMobileNav(!mobileNav)}>
                  Registration
                </Link>
              </div>
              ...
              <ul className="flex flex-col justify-start items-start gap-y-6 my-12 text-sm font-semibold">
                <li className="hover:text-redColor">
                  <NavLink to={'..'} onClick={()=>setMobileNav(!mobileNav)}>
                    Accueil
                  </NavLink>
                </li>
                ...
                <li className="hover:text-redColor">
                  <NavLink to={'/flash-deals'} onClick={()=>setMobileNav(!mobileNav)}>
                    Vente flash
                  </NavLink>
                </li>

                <li className="hover:text-redColor">
                  <NavLink to={'/blog'} onClick={()=>setMobileNav(!mobileNav)}>
                    Blog
                  </NavLink>
                </li>
                ...
                <li className="hover:text-redColor">
                  <NavLink to={'/brands'} onClick={()=>setMobileNav(!mobileNav)}>
                    Toutes les marques
                  </NavLink>
                </li>

                <li className="hover:text-redColor">
                  <NavLink to={'/categories'} onClick={()=>setMobileNav(!mobileNav)}>
                ...
                <li className="hover:text-redColor">
                  <NavLink to={'/TradeAnsurance'} onClick={()=>setMobileNav(!mobileNav)}>
                    Assurance commerciale
                  </NavLink>
                </li>

                <li className="hover:text-redColor">
                  <NavLink to={'/devisgratuit'} onClick={()=>setMobileNav(!mobileNav)}>
                    Devis gratuit
                  </NavLink>
                </li>
              </ul>
